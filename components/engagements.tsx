...
const EngagementRow = React.forwardRef(
  (props: Engagement, ref: ForwardedRef<HTMLElement>) => {
    ...
    return (
      <Grid>
        ...
        <section className='col-start-5 col-end-6 mr-10 mx-auto relative w-full flex items-center justify-center'>
