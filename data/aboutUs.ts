...
export const amigoSkills: Skill[] = [
    {
        ...
        amigos: {
            jacek:
                'I love the art involved in finding the next simplest thing that bring value for users - and repeating that week after week',
    ...
    },
    {
        ...
        amigos: {
            jacek:
                'I enjoy iterating on different parts of the stack as I improve the product and unlock user value',
    ...
    },
    {
        ...
        amigos: {
            ...
            jacek:
                'Like with software, teams needs engineering and debugging. Values and principles are crucial for long-term success',
        },
    },
    {
        skill: {name: 'Web Security', category: 'Execution'},
        amigos: {
            jc: 'I love web security, with a focus on OIDC and robust authorization architectures',
        },
    },
    {
        skill: {name: 'People management', category: 'Leadership'},
        amigos: {
            ben: 'The hardest problem in software is people. Keeping engineers happy and growing their careers is half the battle',
        },
    },
    {
        ...
        amigos: {
            jacek:
                'Normal software engineering practices like TDD apply perfectly to data engineering and result in reliable pipelines',
        },
    },
    {
        skill: {name: 'Architecture', category: 'Leadership'},
        amigos: {
            jc: 'I believe in bottom-up architecture, with an emphasis on discovering bounded contexts',
        },
    },
]
